...
$sql="update  tblclasses set ClassName=:classname,Semester=:semester,Section=:section where id=:cid ";
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- MCA, ECE,CSE etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Semester</label>
                                                        <div class="">
                                                            <input type="text" name="semester" value="<?php echo htmlentities($result->Semester);?>" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- 1st,2nd,3rd,4th etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
