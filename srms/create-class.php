...
$sql="INSERT INTO  tblclasses(ClassName,Semester,Section) VALUES(:classname,:semester,:section)";
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="semester" required="required" class="form-control" id="success">
